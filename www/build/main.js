...
var LolDataProvider = /** @class */ (function () {
    ...
    function LolDataProvider(http, storage) {
        var _this = this;
        this.http = http;
        this.storage = storage;
